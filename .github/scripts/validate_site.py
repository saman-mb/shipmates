...
C3_CLASSES = (
    ...
    "order-crew", "order-crew__strip", "order-crew__chip",
    "order-stages", "order-stage", "order-stage__num",
    "order-stage__details", "order-stage__summary",
    "order-stage__title", "order-stage__gate", "order-stage__crew",
    "order-stage__crew-item", "order-stage__body",
    "order-advanced", "order-advanced__summary", "order-advanced__title",
    "order-advanced__hint", "order-advanced__body",
