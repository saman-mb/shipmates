...
---
# /shipmates-pr-review — classify → convene the board → consolidate
...
flags for scaled optional seats. **`/shipmates-pr-review`-specific additions** on top of the shared board:
