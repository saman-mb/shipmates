...
test "$(ls -1 "$PROJECT/.agents/skills" | wc -l | tr -d ' ')" -eq 16
...
command = [
    ...
    (
        "Use the installed ship-harden skill in its default report mode on README.md and AGENTS.md "
...
printf 'Optional Codex runtime smoke passed: installed crew resolved and read-only ship-harden skill completed.\n'
