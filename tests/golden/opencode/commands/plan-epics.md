...
- Issue-body trailer: `Opencode-Session: ...` on every epic and story (read from the harness/session
...
- If a role doesn't resolve to a `.opencode/agents/*.md`, fall back to `general` with the
