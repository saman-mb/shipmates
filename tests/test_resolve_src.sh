...
assert "claude-code: skill under .claude/skills" test -f "$D/.claude/skills/shipmates-ship-issue/SKILL.md"
...
assert "opencode: command under .opencode/commands" test -f "$D/.opencode/commands/shipmates-ship-issue.md"
...
assert "antigravity: skill under .agents/skills" test -f "$D/.agents/skills/shipmates-ship-issue/SKILL.md"
...
assert "codex: skill under .agents/skills" test -f "$D/.agents/skills/shipmates-ship-issue/SKILL.md"
...
assert "github-copilot: skill under .agents/skills" test -f "$D/.agents/skills/shipmates-ship-issue/SKILL.md"
...
assert "grok-build: skill under .grok/skills" test -f "$D/.grok/skills/shipmates-ship-issue/SKILL.md"
assert "grok-build: command keeps disable-model-invocation" grep -q '^disable-model-invocation: true' "$D/.grok/skills/shipmates-ship-issue/SKILL.md"
...
assert "global antigravity: commands under .gemini/config/skills" test -f "$GHOME/.gemini/config/skills/shipmates-ship-issue/SKILL.md"
...
assert "global codex: skills at ~/.codex/skills, not the shared tree" test -f "$GHOME/.codex/skills/shipmates-ship-issue/SKILL.md"
...
assert "global github-copilot: skills at ~/.copilot/skills" test -f "$GHOME/.copilot/skills/shipmates-ship-issue/SKILL.md"
...
mkdir -p "$SHOME/.agents/skills/shipmates-ship-issue" "$SHOME/.gemini/config/skills"
printf -- '---\nname: shipmates-ship-issue\ndescription: mine\n---\nbody\n' > "$SHOME/.agents/skills/shipmates-ship-issue/SKILL.md"
ln -s "$SHOME/.agents/skills/shipmates-ship-issue" "$SHOME/.gemini/config/skills/shipmates-ship-issue"
...
assert "symlinked path: the user's own file is untouched" grep -q 'description: mine' "$SHOME/.gemini/config/skills/shipmates-ship-issue/SKILL.md"
...
assert "symlinked path: doctor --fix leaves it alone" bash -c "HOME='$SHOME' '$BIN' doctor --fix --harness antigravity >/dev/null; grep -q 'description: mine' '$SHOME/.gemini/config/skills/shipmates-ship-issue/SKILL.md'"
...
assert "embedded: skill from embedded payload" test -f "$EMBED/.claude/skills/shipmates-ship-issue/SKILL.md"
assert "embedded: agent from embedded payload" test -f "$EMBED/.claude/agents/sdet.md"
assert "embedded: twenty-nine skills emitted (commands + tools)" test "$(ls "$EMBED/.claude/skills" | wc -l | tr -d ' ')" -eq 29
