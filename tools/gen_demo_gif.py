#!/usr/bin/env python3
"""Generate site/assets/demo.gif — an illustrative animated terminal of a `/shipmates-ship-issue` run.
...
def render_frames(font_dir=None):
    ...
    def base_frame():
        ...
        title = "shipmates — /shipmates-ship-issue"
