...
# reel that reuses a stage name paints it the same hue the /shipmates-ship-issue reel does.
BLUE   = (130, 170, 255)
PURPLE = (170, 150, 255)
ORANGE = (255, 180, 90)
CYAN   = (95, 210, 220)
...
class Reel:
    ...
    def stage(self, label, color, running, done, done_detail_color=GREY, cycles=4):
        """Spinner-running then a green ✓ done line — the /shipmates-ship-issue reel's
