...
- **Repo mandatory ship checklist.** Read the project's README / {{project-instructions}} / contributing docs. For this change class, verify required steps actually happened: regenerated generated pages, updated fixture digests, version/changelog bumps when required, site/docs validation gates, no hand-edited generated paths, and any other contributor process the repo declares mandatory. A green CI run does not substitute for a missing digest or stale generated file.
