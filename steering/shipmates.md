...
| opencode, codex, antigravity, pi | `.shipmates/contributor-steering.md` (no documented auto-load path yet) |
| devin | `.devin/rules/shipmates-contributor.md` (`trigger: always_on`) |
